...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (noGuiLink && !noGuiLink.href.includes('pc-terminal')) {
        noGuiLink.href = 'pc-terminal/pc-terminal.html';
    }
    ...
    window.addEventListener('scroll', () => {
        ...
        // Hide/show based on scroll direction (only after scrolling past header)
